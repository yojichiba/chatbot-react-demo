const defaultDataset = {
    "init": {
        ...
        question: "こんにちは！😈クリムゾンへのご用件はなんでしょうか？",
    },
    "job_offer": {
        answers: [
    ...
    "consultant": {
        answers: [
            {content: "YouTubeで動画を見る", nextId: "https://www.youtube.com/watch?v=JvVOWZqTRgQ"},
            {content: "学習コミュニティについて知りたい", nextId: "community"},
            {content: "最初の質問に戻る", nextId: "init"}
        ],
        question: "クリムゾンは普段からYouTubeでキャリアについて発信しています。また、僕が運営するエンジニア向け学習コミュニティ内でも相談に乗っていますよ。",
    },
    "community": {
        answers: [
            {content: "どんな活動をしているの？", nextId: "community_activity"},
            {content: "コミュニティに参加したい", nextId: "https://www.star-crimson.jp/"},
            {content: "最初の質問に戻る", nextId: "init"}
        ],
    ...
    "community_activity": {
        answers: [
            {content: "さらに詳細を知りたい", nextId: "https://www.youtube.com/watch?v=jo2vH4bUsEY&t=325s"},
            {content: "コミュニティに参加したい", nextId: "https://www.star-crimson.jp/"},
            {content: "最初の質問に戻る", nextId: "init"}
        ],
